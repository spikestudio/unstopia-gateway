...
| 規約準拠 | `skills/aidd-review/references/step2-review-code.md` に従って確認 |
...
| テスト | リグレッションテストが追加されているか |
| 規約準拠 | `skills/aidd-review/references/step2-review-code.md` の主要観点のみ確認 |
...
問題を発見した場合は `aidd-review/references/step3-agree-fix.md` に従って修正し、再チェックする（最大 3 ラウンド）。
