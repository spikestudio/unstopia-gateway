...
vi.mock("../../shared/paths.js", () => ({
  SESSIONS_DB: ":memory:",
  JINN_HOME: path.join(os.tmpdir(), ".jinn-test"),
  CONFIG_PATH: path.join(os.tmpdir(), ".jinn-test", "config.yaml"),
  CRON_JOBS: path.join(os.tmpdir(), ".jinn-test", "cron", "jobs.json"),
  CRON_RUNS: path.join(os.tmpdir(), ".jinn-test", "cron", "runs"),
  ORG_DIR: path.join(os.tmpdir(), ".jinn-test", "org"),
  SKILLS_DIR: path.join(os.tmpdir(), ".jinn-test", "skills"),
  DOCS_DIR: path.join(os.tmpdir(), ".jinn-test", "docs"),
  LOGS_DIR: path.join(os.tmpdir(), ".jinn-test", "logs"),
  TMP_DIR: path.join(os.tmpdir(), ".jinn-test", "tmp"),
  MODELS_DIR: path.join(os.tmpdir(), ".jinn-test", "models"),
  STT_MODELS_DIR: path.join(os.tmpdir(), ".jinn-test", "models", "whisper"),
  PID_FILE: path.join(os.tmpdir(), ".jinn-test", "gateway.pid"),
  CLAUDE_SKILLS_DIR: path.join(os.tmpdir(), ".jinn-test", ".claude", "skills"),
  AGENTS_SKILLS_DIR: path.join(os.tmpdir(), ".jinn-test", ".agents", "skills"),
  TEMPLATE_DIR: path.join(os.tmpdir(), ".jinn-test", "template"),
  FILES_DIR: path.join(os.tmpdir(), ".jinn-test", "files"),
  MIGRATIONS_DIR: path.join(os.tmpdir(), ".jinn-test", "migrations"),
  TEMPLATE_MIGRATIONS_DIR: path.join(os.tmpdir(), ".jinn-test", "template", "migrations"),
